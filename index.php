...
$categorias = "SELECT cve_categoria,nombre,imagen as imagen FROM categoria";
$resultados_categorias = mysqli_query($conexion,$categorias);
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    ...
    <div class="articulos">
        <section class="pedidos">
            <?php while($categoria = mysqli_fetch_array($resultados_categorias)){?>
                <article class="pr">
                    <a href="catalogo1.php?cve_categoria=<?php echo $categoria['cve_categoria']; ?>"><img src="admin/secciones/<?php echo $categoria['imagen']; ?>" alt=""></a>
